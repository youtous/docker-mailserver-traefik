...
readonly doc_file=$basedir"/docker-compose.file.yml"
...
main() {
    ...
    case $1 in
        ...
        "--start")
            ...
            start_boulder
            echo "START Traefik, mailserver and autorenew-mailserver-certs container"
            up_environment_attached --build traefik mailserver autorenew-mailserver-certs
            ;;
        "--stop")
            ! down_environment
